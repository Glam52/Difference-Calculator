...
def test_stylish_json():
    ...
    final_file = open(os.path.join(os.path.dirname(__file__), "fixtures", "result_stylish"), "r").read()
...
def test_stylish_yaml():
    ...
    final_file = open(os.path.join(os.path.dirname(__file__), "fixtures", "result_yaml"), "r").read()
...
def test_plain():
    file1 = os.path.join(os.path.dirname(__file__), "fixtures", "file1.json")
    file2 = os.path.join(os.path.dirname(__file__), "fixtures", "file2.json")
    final_file = open(os.path.join(os.path.dirname(__file__), "fixtures", "result_plain"), "r").read()
...
def test_json():
    file1 = os.path.join(os.path.dirname(__file__), "fixtures", "file1.json")
    file2 = os.path.join(os.path.dirname(__file__), "fixtures", "file2.json")
    final_file = open(os.path.join(os.path.dirname(__file__), "fixtures", "result_json"), "r").read()
